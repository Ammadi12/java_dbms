...
public class Member extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Matric\t", "Higher Ed", "Bachelors", "Bachelors+" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try 
        {
            ...
            st.executeUpdate("Insert into member VALUES('"+MemberID+"','"+FName+"','"+LName+"','"+Qualifications+"','"+Phone+"','"+Email+"')");
